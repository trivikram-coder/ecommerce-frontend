...
const Checkout = () => {
    ...
    const handleSubmit = (e) => {
        ...
        localStorage.setItem(key, JSON.stringify(prevOrders));
                ...
                <div className="col-lg-7">
                    <div className="card p-4 shadow-lg">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <input className="form-control mb-3" placeholder="Address" name="address" value={formData.address} onChange={handleChange} required />
                            <div className="row mb-3">
                                <div className="col-md-6">
                                    <input className="form-control" placeholder="City" name="city" value={formData.city} onChange={handleChange} required />
                                </div>
                                <div className="col-md-6">
                                    <input className="form-control" placeholder="ZIP" name="zip" value={formData.zip} onChange={handleChange} required />
                                </div>
                            </div>
                            ...
                            <input className="form-control mb-3" placeholder="Card Number" name="cardNumber" onChange={handleChange} required />
                            <div className="row mb-4">
                                <div className="col-md-6">
                                    <input className="form-control" placeholder="MM/YY" name="expiry" onChange={handleChange} required />
                                </div>
                                <div className="col-md-6">
                                    <input className="form-control" placeholder="CVV" name="cvv" type="password" onChange={handleChange} required />
                                </div>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="quantity-controls mt-1">
                                            <button className="btn btn-sm btn-outline-secondary"
                                                onClick={() => updateQuantity(item.id, "dec")}>−</button>
                                            <span className="mx-2">{item.quantity}</span>
                                            <button className="btn btn-sm btn-outline-secondary"
                                                onClick={() => updateQuantity(item.id, "inc")}>+</button>
                                        </div>
                                    </div>
